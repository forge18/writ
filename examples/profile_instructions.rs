...
fn opcode_name(instr: &Instruction) -> &'static str {
    match instr {
        ...
        Instruction::LoadConstInt(_) => "LoadConstInt",
        Instruction::LoadFloat(_) => "LoadFloat",
        Instruction::LoadConstFloat(_) => "LoadConstFloat",
        Instruction::LoadBool(_) => "LoadBool",
        Instruction::LoadStr(_) => "LoadStr",
        ...
        Instruction::CallDirect(_, _) => "CallDirect",
        ...
        Instruction::MakeDict(_) => "MakeDict",
        ...
        Instruction::StartCoroutine(_) => "StartCoroutine",
        ...
        Instruction::LoadUpvalue(_) => "LoadUpvalue",
        Instruction::StoreUpvalue(_) => "StoreUpvalue",
        Instruction::MakeClosure(_) => "MakeClosure",
        Instruction::CloseUpvalue(_) => "CloseUpvalue",
        Instruction::MakeStruct(_, _) => "MakeStruct",
        Instruction::MakeClass(_, _) => "MakeClass",
        ...
        Instruction::IncrLocalInt(_, _) => "IncrLocalInt",
        Instruction::CmpLocalIntJump(_, _, _, _) => "CmpLocalIntJump",
        Instruction::LoadLocalAddInt(_, _) => "LoadLocalAddInt",
        Instruction::LoadLocalSubInt(_, _) => "LoadLocalSubInt",
        Instruction::ReturnLocal(_) => "ReturnLocal",
        Instruction::AddLocals(_, _) => "AddLocals",
        Instruction::SubLocals(_, _) => "SubLocals",
        Instruction::CmpLocalsJump(_, _, _, _) => "CmpLocalsJump",
...
fn main() {
    ...
    for (bench_name, source) in &benchmarks {
        ...
        for (chunk_idx, instrs) in chunks.iter().enumerate() {
            ...
            println!("  [{func_name}] ({} instructions, weight={weight})", instrs.len());
