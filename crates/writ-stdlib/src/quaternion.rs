...
use crate::matrix::mat4_value;
use crate::vector::{extract_f32, extract_vec3, value_to_vec3, vec3_value};
...
pub fn register(vm: &mut VM) {
    ...
    vm.register_fn_in_module(
        ...
        "quaternion",
        writ_vm::binding::fn3(|x: f64, y: f64, z: f64| -> Result<Value, String> {
    ...
    vm.register_fn_in_module(
        ...
        "quaternion",
        writ_vm::binding::fn2(|forward: Value, up: Value| -> Result<Value, String> {
