...
mod tests {
    ...
    fn test_opcode_count() {
        ...
        let opcodes = [
            op::LoadInt, op::LoadConstInt, op::LoadFloat, op::LoadConstFloat,
            op::LoadBool, op::LoadStr, op::LoadNull, op::Move, op::LoadGlobal,
            op::Add, op::Sub, op::Mul, op::Div, op::Mod,
            op::AddInt, op::AddFloat, op::SubInt, op::SubFloat,
            op::MulInt, op::MulFloat, op::DivInt, op::DivFloat,
            op::AddIntImm, op::SubIntImm, op::IntToFloat, op::Neg, op::Not,
            op::Eq, op::Ne, op::Lt, op::Le, op::Gt, op::Ge,
            op::EqInt, op::EqFloat, op::NeInt, op::NeFloat,
            op::LtInt, op::LtFloat, op::LeInt, op::LeFloat,
            op::GtInt, op::GtFloat, op::GeInt, op::GeFloat,
            op::And, op::Or,
            op::Jump, op::JumpIfFalsy, op::JumpIfTruthy,
            op::TestLtInt, op::TestLeInt, op::TestGtInt, op::TestGeInt,
            op::TestEqInt, op::TestNeInt,
            op::TestLtIntImm, op::TestLeIntImm, op::TestGtIntImm, op::TestGeIntImm,
            op::TestLtFloat, op::TestLeFloat, op::TestGtFloat, op::TestGeFloat,
            op::Return, op::ReturnNull,
            op::Call, op::CallDirect, op::CallNative, op::CallMethod, op::TailCallDirect,
            op::NullCoalesce, op::Concat,
            op::MakeArray, op::MakeDict, op::GetIndex, op::SetIndex, op::Spread,
            op::GetField, op::SetField, op::MakeStruct, op::MakeClass,
            op::LoadUpvalue, op::StoreUpvalue, op::MakeClosure, op::CloseUpvalue,
            op::StartCoroutine, op::Yield, op::YieldSeconds, op::YieldFrames,
            op::YieldUntil, op::YieldCoroutine,
            op::QAddInt, op::QAddFloat, op::QSubInt, op::QSubFloat,
            op::QMulInt, op::QMulFloat, op::QDivInt, op::QDivFloat,
            op::QLtInt, op::QLtFloat, op::QLeInt, op::QLeFloat,
            op::QGtInt, op::QGtFloat, op::QGeInt, op::QGeFloat,
            op::QEqInt, op::QEqFloat, op::QNeInt, op::QNeFloat,
        ];
        for &opc in &opcodes {
